...
Results of a firewall log query specified in RQL.
...
Log line from the results of a firewall log query specified in RQL.
...
##### `firewallLogQueryResults` [`read_only`]

Type: [`firewalllog`](#firewalllog)

The firewall log query results.
