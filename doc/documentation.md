...
##### `parsedQuery` [`autogenerated`,`read_only`]
...
```json
{
  ...
  "k8sExposureEnabled": false,
  "nonMatchingAlertsRaisingEnabled": true,
  "protected": false,
  "reRaisePublishedAlerts": false
}
```
...
##### `reRaisePublishedAlertsTime` [`autogenerated`]

Type: `time`

Contains the time when tenant was set to re-raise published alerts.
...
##### `fingerprint` [`autogenerated`,`read_only`]
...
##### `URLReputations` [`autogenerated`,`read_only`]

Type: [`[]urlreputation`](#urlreputation)
...
##### `categories` [`autogenerated`,`read_only`]

Type: `[]integer`

The categories codes related to the risk level.

##### `evidence` [`autogenerated`,`read_only`]

Type: `[]string`

The evidence related to the risk level.

##### `riskLevel` [`autogenerated`,`read_only`]
...
Represents a read-only AWS cloud resource such as a virtual machine.

#### Example

```json
{
  "arn": "arn:aws:ec2:us-west-2:000000000000:instance/i-0abcdef0123456789",
  "data": "{
  ...
  "resourceID": "i-092bf3d4b2422d8a6"
}
```
...
##### `denormedFields` [`autogenerated`,`read_only`]
...
##### `resourceID` [`autogenerated`,`read_only`]
...
Represents a read-only Azure cloud resource such as virtualMachines and subnets.
...
```json
{
  ...
  "kind": "VirtualMachine",
  "name": "vm-name",
  "prismaRRN": "rrn:azure:instance:eastus:00000000-0000-0000-0000-000000000000:0000000000000000000000000000000000000000:/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/Group1/providers/Microsoft.Compute/virtualMachineScaleSets/my-vmss/virtualMachines/0",
  "prismaRegion": "us-east-1",
  "prismaURN": "/subscriptions/a0a00a0a-0aaa-000a-a0a0-00a00aa00000/resourceGroups/my-Deployment/providers/Microsoft.Compute/virtualMachines/vm-name",
  "prismaUnifiedAssetID": "4b882952f1a26c8a3ce16ee90af3cac9",
  "provider": "MicrosoftCompute",
  "resourceGroup": "my-deployment",
  ...
  "subscriptionID": "a0a00a0a-0aaa-000a-a0a0-00a00aa00000"
}
```
...
Retrieves the list of stored azure resources.
...
Type: `enum(Pending | VirtualMachine | NetworkInterface | Subnet | IPConfiguration | VirtualNetwork | NetworkSecurityGroup | NATGateway | PublicIPAddress | PublicIPPrefix | VirtualMachineScaleSet | VirtualMachineScaleSetVM | LoadBalancer | LoadBalancingRule | BackendAddressPool | OutboundRule | RouteTable | FrontendIPConfiguration | ApplicationGateway | RoutingRule | Listener | URLPathMap | PathRule | BackendSettings | FrontendPort | DatabaseAccount | FlexibleServer | Server)`
...
##### `provider` [`autogenerated`,`read_only`]

Type: `enum(Pending | MicrosoftCompute | MicrosoftNetwork | MicrosoftDocumentDB | MicrosoftDBforMySQL | MicrosoftSQL | MicrosoftDBforPostgreSQL)`
...
##### `resourceGroup` [`autogenerated`,`read_only`]
...
##### `subscriptionID` [`autogenerated`,`read_only`]
...
##### `GET /cloudaccountstatuses`

Retrieves the list of the cloud account status objects.

Parameters:

- `q` (`string`): Filtering query. Consequent `q` parameters will form an or.

##### `POST /cloudaccountstatuses`

Creates a cloud account status object for the specified namespace.

##### `DELETE /cloudaccountstatuses/:id`

Deletes the cloud account status with the given ID.

##### `GET /cloudaccountstatuses/:id`

Retrieve the cloud account status with the given ID.

##### `PUT /cloudaccountstatuses/:id`
...
Control message model to raise/resolve/generate cloud alerts.
...
Type: `enum(Generate | Raise | Resolve)`
...
```json
{
  ...
  "resourceID": 12344555,
  "unifiedAssetID": "4b882952f1a26c8a3ce16ee90af3cac9"
}
```
...
{
  "direction": "Outbound",
  "prismaCloudPolicyID": "ad23603d-754e-4499-8988-b80178785898",
  "unifiedAssetIDs": "4b882952f1a26c8a3ce16ee90af3cac9"
}
```

#### Relations

##### `POST /cloudgraphassets`

Creates a cloud graph asset.

Parameters:

- `disableCacheLookup` (`boolean`): If set, cloud graph cache lookup will be disabled.

#### Attributes

##### `cloudGraphs` [`autogenerated`,`read_only`]

Type: [`map[string]cloudgraph`](#cloudgraph)
...
##### `executionTimestamp` [`autogenerated`,`read_only`]

Type: `time`

Result of the graph execution timestamp.

##### `prismaCloudPolicyID` [`required`]

Type: `string`

Prisma Cloud Policy ID.

##### `unifiedAssetIDs` [`required`]
...
Type: `enum(Summary | CompressedGraph | FullGraph | NetworkPath)`
...
Type: `enum(Interface | Instance | LoadBalancer | PublicIP | K8sService)`
...
Type: `enum(Instance | Interface | Service | ProcessingUnit | PaaS | K8sService)`
...
##### `ipRanges` [`autogenerated`,`read_only`]

Type: [`[]cloudiprange`](#cloudiprange)

A list of ips range.

##### `localNetworks` [`read_only`]

Type: `[]string`

A list of IP CIDRS that identify local endpoints.

##### `localServiceTags` [`read_only`]
...
##### `serviceTags` [`read_only`]

Type: `[]string`

A list of Service Tags provided by the platform.

##### `storedIPRanges` [`autogenerated`,`read_only`]

Type: [`[]cloudstorediprange`](#cloudstorediprange)

A list of ips range for internal use. Not visible to end users.

##### `storedLocalNetworks` [`autogenerated`,`read_only`]
...
Type: `enum(EgressOnlyGateway | Gateway | Instance | LocalGateway | NATGateway | NetworkInterface | TransitGateway | VPCPeeringConnection | TransitGatewayAttachment | Drop)`
...
##### `GET /cloudscalegroups/:id`

Retrieves the object with the given ID.

##### `PUT /cloudscalegroups/:id`
...
Type: [`cloudscalegroupdata`](#cloudscalegroupdata)
...
Manages the properties associated to a Auto Scaling Group.
...
Represents a read-only K8s resource such as a service.
...
Type: `enum(Cluster | DaemonSet | Deployment | Endpoints | EndpointSlices | Ingress | Namespace | NetworkPolicy | Node | ReplicaSet | Service | StatefulSet)`
...
Represents an Alert that was raised and later resolved.

#### Relations

##### `GET /resolvedcloudalertrecords`

Retrieves alerts that were raised and later resolved.

Parameters:

- `q` (`string`): Filtering query. Consequent `q` parameters will form an or.

##### `GET /resolvedcloudalertrecords/:id`

Retrieves the Resolved Alert Record with a given id.
...
Type: [`cloudalertrecord`](#cloudalertrecord)
...
Type: `enum(Docker | ExternalNetwork | Volume | Claim | Node | Namespace | RemoteController | APIGateway | Host | HostService | LinuxService | WindowsService | RKT | User | SSHSession | ECS)`
...
##### `result` [`autogenerated`,`read_only`]

Type: [`metricsqueryresult`](#metricsqueryresult)
