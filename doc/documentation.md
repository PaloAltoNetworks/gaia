...
```json
{
  ...
  "nonMatchingCloudAccountScanEnabled": false,
  "protected": false
}
```
...
Represents a GCP cloud resource such as a virtual machine.
...
Type: `enum(ComputeInstance | ComputeSubnetwork | ComputeNetwork | ComputeFirewall | ComputeFirewallPolicy | ResourceFolder | ResourceProject)`
