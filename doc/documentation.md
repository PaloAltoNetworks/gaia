...
{
  "cloudTypes": "gcp",
  "optionSelectIPRulesWithFullCoverage": false
}
```
...
Parameters to start a flooder.

#### Example

```json
{
  "optionContinueOnErrNotPermitted": false,
  "optionOnlyReportResultsWithErrNotPermitted": false
}
```
...
##### `pathExists` [`autogenerated`,`read_only`]

Type: `boolean`

Set if flooder found at least one trail.

##### `trails` [`autogenerated`,`read_only`]
...
Starts a flooder for a given source/destination/payload triplet.

#### Example

```json
{
  "optionResultOmitTrails": false,
  "sessionID": "47a0479900504cb3ab4a1f626d174d2d"
}
```
