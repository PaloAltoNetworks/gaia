...
Type: `enum(Pending | VirtualMachine | NetworkInterface | Subnet | IPConfiguration | VirtualNetwork | NetworkSecurityGroup | NATGateway | PublicIPAddress | PublicIPPrefix | VirtualMachineScaleSet | VirtualMachineScaleSetVM | LoadBalancer | BackendAddressPool | OutboundRule | FrontendIPConfiguration | DatabaseAccount | FlexibleServer | Server | FirewallRule)`
