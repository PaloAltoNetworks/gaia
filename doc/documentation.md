...
Type: `enum(Pending | Instance | NetworkInterface | VPC | Subnet | NetworkACL | InternetGateway | SecurityGroup | FakeTarget | LoadBalancerApplication | LoadBalancerNetwork | LoadBalancerGateway | LoadBalancerClassic)`
