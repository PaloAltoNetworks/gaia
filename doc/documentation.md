...
Type: `enum(Pending | MicrosoftCompute | MicrosoftNetwork | MicrosoftDocumentDB | MicrosoftDBforMySQL)`
...
Type: `enum(ComputeInstance | ComputeSubnetwork | ComputeNetwork | ComputeFirewall | ComputeFirewallPolicy | ComputeForwardingRule | ComputeBackendService | ComputeTargetHTTPProxy | ComputeTargetHTTPSProxy | ComputeRegion | ComputeZone | ComputeURLMap | ComputeInstanceGroup | ResourceFolder | ResourceProject | Pending)`
