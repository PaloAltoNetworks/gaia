...
Represents an ingress or egress network labeling rule.
...
##### `ruleSetLabelPolicies` [`autogenerated`,`read_only`]
...
##### `GET /networklabelrulesetpolicies/:id/processingunits`
...
##### `GET /networklabelrulesetpolicies/:id/externalnetworks`
...
##### `GET /networklabelrulesetpolicies/:id`
...
##### `PUT /networklabelrulesetpolicies/:id`
...
Type: [`[]networklabelrule`](#networklabelrule)
