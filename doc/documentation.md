...
Type: `enum(ComputeInstance | ComputeSubnetwork | ComputeNetwork | ComputeFirewall | ComputeFirewallPolicy | ComputeForwardingRule | ComputeBackendService | ComputeRegion | ComputeZone | ComputeURLMap | ResourceFolder | ResourceProject | Pending)`
