...
Represent a top port within a bucket.
...
- `numberOfTopEntries` (`integer`): if set, it will return the top ports up to the number specified (default 10).
- `q` (`string`): Filtering query. Consequent `q` parameters will form an or.

#### Attributes

##### `entry` [`autogenerated`,`read_only`]

Type: `string`

The entry encountered.

##### `occurrences` [`autogenerated`,`read_only`]
