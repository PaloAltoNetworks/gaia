...
```json
{
  ...
  "prismaResourceID": "/subscriptions/a0a00a0a-0aaa-000a-a0a0-00a00aa00000/resourceGroups/my-deployment/providers/Microsoft.Compute/virtualMachines/vm-name",
...
##### `prismaResourceID` [`autogenerated`,`read_only`]

Type: `string`

The identifier of the resource as presented by Prisma Cloud, which is a path.
This is same as the resourceID but honors Prisma Cloud.
