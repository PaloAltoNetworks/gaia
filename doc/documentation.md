...
Defines the Next-Generation Firewall (NGFW) group of metrics.

#### Relations

##### `GET /ngfwgroupmetrics`

Retrieves a list of NGFW group of metrics.

Parameters:

- `timerange` (`enum(day | week | month | quarter | year)`): If set, query the metrics based on the specified time range.

#### Attributes

##### `countCreditsConsumed` [`autogenerated`,`read_only`]

Type: `integer`

The number of Prisma Cloud credits consumed.

##### `countInstancesAdvancedLicense` [`autogenerated`,`read_only`]

Type: `integer`

The number of instances with advanced licensing.

##### `countInstancesBasicLicense` [`autogenerated`,`read_only`]

Type: `integer`

The number of instances with basic licensing.

##### `countInstancesNGFWMode` [`autogenerated`,`read_only`]

Type: `integer`

The number of instances in NGFW mode.

##### `countInstancesTAPLicense` [`autogenerated`,`read_only`]

Type: `integer`

The number of instances with TAP licensing.

##### `countInstancesTAPMode` [`autogenerated`,`read_only`]

Type: `integer`

The number of instances in TAP mode.

##### `countPoliciesAutoRemedyEnabled` [`autogenerated`,`read_only`]

Type: `integer`

The number of NGFW policies with auto-remediation enabled.

##### `countTenantsNGFWEnabled` [`autogenerated`,`read_only`]

Type: `integer`

The number of tenants with NGFW enabled.

##### `countThreatsBlocked` [`autogenerated`,`read_only`]

Type: `integer`

The number of threats blocked.

##### `countThreatsDetected` [`autogenerated`,`read_only`]
