...
##### `clusterID` [`autogenerated`,`read_only`]
...
Type: `enum(Pending | Pods | Deployment | ReplicaSets | StatefulSets | DaemonSets | Namespace | NetworkPolicy | Cluster | Service | Endpoints)`
