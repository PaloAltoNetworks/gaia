...
func (o *CurrentConnection) GetNamespace() string {

	return o.Namespace
}

// SetNamespace sets the property Namespace of the receiver using the given value.
func (o *CurrentConnection) SetNamespace(namespace string) {
...
// GetNamespace returns the Namespace of the receiver.
func (o *SparseCurrentConnection) GetNamespace() (out string) {
...
func (o *SparseCurrentConnection) SetNamespace(namespace string) {
