...
const (
	...
	// K8sResourceKindDaemonSets represents the value DaemonSets.
	K8sResourceKindDaemonSets K8sResourceKindValue = "DaemonSets"
	...
	// K8sResourceKindPods represents the value Pods.
	K8sResourceKindPods K8sResourceKindValue = "Pods"

	// K8sResourceKindReplicaSets represents the value ReplicaSets.
	K8sResourceKindReplicaSets K8sResourceKindValue = "ReplicaSets"

	// K8sResourceKindService represents the value Service.
	K8sResourceKindService K8sResourceKindValue = "Service"

	// K8sResourceKindStatefulSets represents the value StatefulSets.
	K8sResourceKindStatefulSets K8sResourceKindValue = "StatefulSets"
)
