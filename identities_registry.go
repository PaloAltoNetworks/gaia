...
var (
	...
	identitycategoriesMap = map[string]elemental.Identity{
		...
		"awsassets":                   AWSAssetIdentity,
		"awsresources":                AWSResourceIdentity,
	...
	indexesMap = map[string][][]string{
		...
		"awsresource": {
			...
			{"prismaID", "accountID"},
			{"prismaID", "arn"},
			{"prismaID", "denormedFields"},
			{"prismaID", "kind", "accountID", "denormedFields"},
			{"prismaID", "kind", "arn", "denormedFields"},
			{"prismaID", "kind", "denormedFields"},
			{"prismaID", "kind", "name", "denormedFields"},
			{"prismaID", "kind", "prismaRegion", "denormedFields"},
			{"prismaID", "kind", "resourceID", "denormedFields"},
			{"prismaID", "name"},
			{"prismaID", "resourceID"},
		},
		"azureasset": {
		...
		"cloudalertrecord": {
			...
			{"name"},
			{"namespace"},
			{"namespace", "lastexecutiontimestamp", "resourceType"},
			{"namespace", "name"},
			{"namespace", "normalizedTags"},
		...
		"cloudalertrule": {
			...
			{"name"},
			{"namespace"},
			{"namespace", "enabled", "prismaCloudPolicyIDs"},
			{"namespace", "name"},
			{"namespace", "normalizedTags"},
			{"namespace", "prismaCloudAlertRuleID"},
			{"namespace", "prismaCloudPolicyIDs", "enabled"},
			{"updateIdempotencyKey"},
		},
...
func (f modelManager) Identifiable(identity elemental.Identity) elemental.Identifiable {
	...
	case AWSAssetIdentity:
		return NewAWSAsset()
	case AWSResourceIdentity:
		return NewAWSResource()
...
func (f modelManager) SparseIdentifiable(identity elemental.Identity) elemental.SparseIdentifiable {
	...
	case AWSAssetIdentity:
		return NewSparseAWSAsset()
	case AWSResourceIdentity:
		return NewSparseAWSResource()
	case AzureAssetIdentity:
...
func (f modelManager) Identifiables(identity elemental.Identity) elemental.Identifiables {
	...
	case AWSAssetIdentity:
		return &AWSAssetsList{}
	case AWSResourceIdentity:
		return &AWSResourcesList{}
	case AzureAssetIdentity:
