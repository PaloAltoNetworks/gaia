...
var (
	identityNamesMap = map[string]elemental.Identity{
		...
		"networklabelrulesetpolicy": NetworkLabelRuleSetPolicyIdentity,
	...
	identitycategoriesMap = map[string]elemental.Identity{
		...
		"networklabelrulesetpolicies": NetworkLabelRuleSetPolicyIdentity,
	...
	aliasesMap = map[string]elemental.Identity{
		...
		"netlabelruleset":      NetworkLabelRuleSetPolicyIdentity,
		"netlabelrulesets":     NetworkLabelRuleSetPolicyIdentity,
		"netlabelset":          NetworkLabelRuleSetPolicyIdentity,
		"netlabelsets":         NetworkLabelRuleSetPolicyIdentity,
		"networklabelruleset":  NetworkLabelRuleSetPolicyIdentity,
		"networklabelrulesets": NetworkLabelRuleSetPolicyIdentity,
...
func (f modelManager) Identifiable(identity elemental.Identity) elemental.Identifiable {
	...
	case NetworkLabelRuleSetPolicyIdentity:
		return NewNetworkLabelRuleSetPolicy()
...
func (f modelManager) SparseIdentifiable(identity elemental.Identity) elemental.SparseIdentifiable {
	...
	case NetworkLabelRuleSetPolicyIdentity:
		return NewSparseNetworkLabelRuleSetPolicy()
	case NetworkRuleSetPolicyIdentity:
...
func (f modelManager) Identifiables(identity elemental.Identity) elemental.Identifiables {
	...
	case NetworkLabelRuleSetPolicyIdentity:
		return &NetworkLabelRuleSetPoliciesList{}
	case NetworkRuleSetPolicyIdentity:
...
func (f modelManager) SparseIdentifiables(identity elemental.Identity) elemental.SparseIdentifiables {
	...
	case NetworkLabelRuleSetPolicyIdentity:
		return &SparseNetworkLabelRuleSetPoliciesList{}
	case NetworkRuleSetPolicyIdentity:
...
func AllIdentities() []elemental.Identity {
	...
	return []elemental.Identity{
		...
		NetworkLabelRuleSetPolicyIdentity,
