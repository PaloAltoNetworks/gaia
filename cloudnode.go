...
const (
	...
	// CloudNodeTypeK8sPod represents the value K8sPod.
	CloudNodeTypeK8sPod CloudNodeTypeValue = "K8sPod"
...
// GetK8sNamespace returns the K8sNamespace of the receiver.
func (o *SparseCloudNode) GetK8sNamespace() (out string) {
...
func (o *SparseCloudNode) SetK8sNamespace(K8sNamespace string) {
