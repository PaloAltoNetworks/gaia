...
const (
	...
	// CloudNodeTypeK8sNamespace represents the value K8sNamespace.
	CloudNodeTypeK8sNamespace CloudNodeTypeValue = "K8sNamespace"

	// CloudNodeTypeK8sNode represents the value K8sNode.
	CloudNodeTypeK8sNode CloudNodeTypeValue = "K8sNode"
...
func (o *CloudNode) Validate() error {
	...
	if err := elemental.ValidateStringInList("type", string(o.Type), []string{"Endpoint", "Subnet", "VPC", "Interface", "RouteTable", "NetworkRuleSet", "LoadBalancer", "LoadBalancerRoute", "PublicIPAddress", "ScaleSet", "ScaleGroup", "K8sNode", "K8sService", "K8sNamespace"}, false); err != nil {
		errors = errors.Append(err)
	}
...
var CloudNodeAttributesMap = map[string]elemental.AttributeSpecification{
	...
	"Type": {
		AllowedChoices: []string{"Endpoint", "Subnet", "VPC", "Interface", "RouteTable", "NetworkRuleSet", "LoadBalancer", "LoadBalancerRoute", "PublicIPAddress", "ScaleSet", "ScaleGroup", "K8sNode", "K8sService", "K8sNamespace"},
		BSONFieldName:  "type",
		ConvertedName:  "Type",
...
// GetK8sClusterName returns the K8sClusterName of the receiver.
func (o *SparseCloudNode) GetK8sClusterName() (out string) {
...
func (o *SparseCloudNode) SetK8sClusterName(K8sClusterName string) {
...
// GetUnifiedAssetID returns the UnifiedAssetID of the receiver.
func (o *SparseCloudNode) GetUnifiedAssetID() (out string) {
...
func (o *SparseCloudNode) SetUnifiedAssetID(unifiedAssetID string) {
