...
func (o *CloudLoadBalancer) GetBSON() (any, error) {
...
func (o *CloudLoadBalancer) GetK8sNamespace() string {

	return o.K8sNamespace
}

// SetK8sNamespace sets the property K8sNamespace of the receiver using the given value.
func (o *CloudLoadBalancer) SetK8sNamespace(K8sNamespace string) {
...
func (o *CloudLoadBalancer) GetUnifiedAssetID() string {

	return o.UnifiedAssetID
}

// SetUnifiedAssetID sets the property UnifiedAssetID of the receiver using the given value.
func (o *CloudLoadBalancer) SetUnifiedAssetID(unifiedAssetID string) {
...
func (o *CloudLoadBalancer) ValueForAttribute(name string) any {
...
// GetBSON implements the bson marshaling interface.
// This is used to transparently convert ID to MongoDBID as ObectID.
func (o *SparseCloudLoadBalancer) GetBSON() (any, error) {
...
// GetK8sNamespace returns the K8sNamespace of the receiver.
func (o *SparseCloudLoadBalancer) GetK8sNamespace() (out string) {
...
func (o *SparseCloudLoadBalancer) SetK8sNamespace(K8sNamespace string) {
...
// GetUnifiedAssetID returns the UnifiedAssetID of the receiver.
func (o *SparseCloudLoadBalancer) GetUnifiedAssetID() (out string) {
...
func (o *SparseCloudLoadBalancer) SetUnifiedAssetID(unifiedAssetID string) {
