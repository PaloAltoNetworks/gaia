...
type PCSearchResult struct {
	...
	FirewallLogQueryResults *FirewallLog `json:"firewallLogQueryResults" msgpack:"firewallLogQueryResults" bson:"-" mapstructure:"firewallLogQueryResults,omitempty"`
...
func NewPCSearchResult() *PCSearchResult {
	...
	return &PCSearchResult{
		ModelVersion:            1,
		FirewallLogQueryResults: NewFirewallLog(),
...
func (o *PCSearchResult) ToSparse(fields ...string) elemental.SparseIdentifiable {
	...
	if len(fields) == 0 {
		...
		return &SparsePCSearchResult{
			FirewallLogQueryResults: o.FirewallLogQueryResults,
	...
	for _, f := range fields {
		switch f {
		case "firewallLogQueryResults":
			sp.FirewallLogQueryResults = o.FirewallLogQueryResults
		case "internalEdges":
...
func (o *PCSearchResult) Patch(sparse elemental.SparseIdentifiable) {
	...
	if so.FirewallLogQueryResults != nil {
		o.FirewallLogQueryResults = so.FirewallLogQueryResults
	}
...
func (o *PCSearchResult) Validate() error {
	...
	if o.FirewallLogQueryResults != nil {
		elemental.ResetDefaultForZeroValues(o.FirewallLogQueryResults)
		if err := o.FirewallLogQueryResults.Validate(); err != nil {
...
func (o *PCSearchResult) ValueForAttribute(name string) interface{} {
	...
	switch name {
	case "firewallLogQueryResults":
		return o.FirewallLogQueryResults
	case "internalEdges":
...
var PCSearchResultAttributesMap = map[string]elemental.AttributeSpecification{
	"FirewallLogQueryResults": {
		AllowedChoices: []string{},
		ConvertedName:  "FirewallLogQueryResults",
...
type SparsePCSearchResult struct {
	// The firewall log query results.
	FirewallLogQueryResults *FirewallLog `json:"firewallLogQueryResults,omitempty" msgpack:"firewallLogQueryResults,omitempty" bson:"-" mapstructure:"firewallLogQueryResults,omitempty"`
...
func (o *SparsePCSearchResult) ToPlain() elemental.PlainIdentifiable {
	...
	if o.FirewallLogQueryResults != nil {
		out.FirewallLogQueryResults = o.FirewallLogQueryResults
	}
