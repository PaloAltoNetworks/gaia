...
type FileAccessReport struct {
	...
	// Action taken.
	Action FileAccessReportActionValue `json:"action,omitempty" msgpack:"action,omitempty" bson:"action" mapstructure:"action,omitempty"`

	// Host storing the file.
	Host string `json:"host,omitempty" msgpack:"host,omitempty" bson:"host" mapstructure:"host,omitempty"`

	// Internal property maintaining migrations information.
	MigrationsLog map[string]string `json:"-" msgpack:"-" bson:"migrationslog" mapstructure:"-,omitempty"`

	// Mode of file access.
	Mode string `json:"mode,omitempty" msgpack:"mode,omitempty" bson:"mode" mapstructure:"mode,omitempty"`

	// Path of the file.
	Path string `json:"path,omitempty" msgpack:"path,omitempty" bson:"path" mapstructure:"path,omitempty"`
