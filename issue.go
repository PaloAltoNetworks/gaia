...
const (
	// IssueRealmAWSIdentityToken represents the value AWSIdentityToken.
	IssueRealmAWSIdentityToken IssueRealmValue = "AWSIdentityToken"
...
func (o *Issue) Validate() error {
	...
	if err := elemental.ValidateStringInList("realm", string(o.Realm), []string{"AWSSecurityToken", "AWSIdentityToken", "Certificate", "Google", "LDAP", "Vince", "GCPIdentityToken", "AzureIdentityToken", "OIDC", "SAML", "AporetoIdentityToken", "PCIdentityToken"}, false); err != nil {
		errors = errors.Append(err)
	}
...
for further information.`,
	...
	"Realm": {
		AllowedChoices: []string{"AWSSecurityToken", "AWSIdentityToken", "Certificate", "Google", "LDAP", "Vince", "GCPIdentityToken", "AzureIdentityToken", "OIDC", "SAML", "AporetoIdentityToken", "PCIdentityToken"},
		ConvertedName:  "Realm",
