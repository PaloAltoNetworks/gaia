...
const (
	// AzureAssetKindApplicationGateway represents the value ApplicationGateway.
	AzureAssetKindApplicationGateway AzureAssetKindValue = "ApplicationGateway"
	...
	// AzureAssetKindBackendSettings represents the value BackendSettings.
	AzureAssetKindBackendSettings AzureAssetKindValue = "BackendSettings"
	...
	// AzureAssetKindFrontendPort represents the value FrontendPort.
	AzureAssetKindFrontendPort AzureAssetKindValue = "FrontendPort"
	...
	// AzureAssetKindListener represents the value Listener.
	AzureAssetKindListener AzureAssetKindValue = "Listener"

	// AzureAssetKindLoadBalancer represents the value LoadBalancer.
	AzureAssetKindLoadBalancer AzureAssetKindValue = "LoadBalancer"

	// AzureAssetKindLoadBalancingRule represents the value LoadBalancingRule.
	AzureAssetKindLoadBalancingRule AzureAssetKindValue = "LoadBalancingRule"
	...
	// AzureAssetKindPathRule represents the value PathRule.
	AzureAssetKindPathRule AzureAssetKindValue = "PathRule"
	...
	// AzureAssetKindRouteTable represents the value RouteTable.
	AzureAssetKindRouteTable AzureAssetKindValue = "RouteTable"

	// AzureAssetKindRoutingRule represents the value RoutingRule.
	AzureAssetKindRoutingRule AzureAssetKindValue = "RoutingRule"
	...
	// AzureAssetKindURLPathMap represents the value URLPathMap.
	AzureAssetKindURLPathMap AzureAssetKindValue = "URLPathMap"
...
const (
	...
	// AzureAssetProviderMicrosoftDBforPostgreSQL represents the value MicrosoftDBforPostgreSQL.
	AzureAssetProviderMicrosoftDBforPostgreSQL AzureAssetProviderValue = "MicrosoftDBforPostgreSQL"
...
func (o *AzureAsset) Validate() error {
	...
	if err := elemental.ValidateStringInList("kind", string(o.Kind), []string{"Pending", "VirtualMachine", "NetworkInterface", "Subnet", "IPConfiguration", "VirtualNetwork", "NetworkSecurityGroup", "NATGateway", "PublicIPAddress", "PublicIPPrefix", "VirtualMachineScaleSet", "VirtualMachineScaleSetVM", "LoadBalancer", "LoadBalancingRule", "BackendAddressPool", "OutboundRule", "RouteTable", "FrontendIPConfiguration", "ApplicationGateway", "RoutingRule", "Listener", "URLPathMap", "PathRule", "BackendSettings", "FrontendPort", "DatabaseAccount", "FlexibleServer", "Server"}, true); err != nil {
...
should be formatted as 'key=value'.`,
	...
	"Kind": {
		AllowedChoices: []string{"Pending", "VirtualMachine", "NetworkInterface", "Subnet", "IPConfiguration", "VirtualNetwork", "NetworkSecurityGroup", "NATGateway", "PublicIPAddress", "PublicIPPrefix", "VirtualMachineScaleSet", "VirtualMachineScaleSetVM", "LoadBalancer", "LoadBalancingRule", "BackendAddressPool", "OutboundRule", "RouteTable", "FrontendIPConfiguration", "ApplicationGateway", "RoutingRule", "Listener", "URLPathMap", "PathRule", "BackendSettings", "FrontendPort", "DatabaseAccount", "FlexibleServer", "Server"},
		Autogenerated:  true,
		BSONFieldName:  "kind",
		ConvertedName:  "Kind",
