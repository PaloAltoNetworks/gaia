...
const (
	...
	// CloudNetworkQueryDestinationTypeLambdaFunction represents the value LambdaFunction.
	CloudNetworkQueryDestinationTypeLambdaFunction CloudNetworkQueryDestinationTypeValue = "LambdaFunction"
	...
	// CloudNetworkQueryDestinationTypeRDSDBInstance represents the value RDSDBInstance.
	CloudNetworkQueryDestinationTypeRDSDBInstance CloudNetworkQueryDestinationTypeValue = "RDSDBInstance"

	// CloudNetworkQueryDestinationTypeRedshiftCluster represents the value RedshiftCluster.
	CloudNetworkQueryDestinationTypeRedshiftCluster CloudNetworkQueryDestinationTypeValue = "RedshiftCluster"
...
func (o *CloudNetworkQueryDestination) Validate() error {
	...
	if err := elemental.ValidateStringInList("type", string(o.Type), []string{"Interface", "Instance", "LoadBalancer", "PublicIP", "K8sService", "MySQLServer", "MySQLFlexibleServer", "PostgreSQLServer", "PostgreSQLFlexibleServer", "CosmosDB", "SQLServer", "LambdaFunction", "RDSDBInstance", "RedshiftCluster"}, true); err != nil {
...
var CloudNetworkQueryDestinationAttributesMap = map[string]elemental.AttributeSpecification{
	...
	"Type": {
		AllowedChoices: []string{"Interface", "Instance", "LoadBalancer", "PublicIP", "K8sService", "MySQLServer", "MySQLFlexibleServer", "PostgreSQLServer", "PostgreSQLFlexibleServer", "CosmosDB", "SQLServer", "LambdaFunction", "RDSDBInstance", "RedshiftCluster"},
		Autogenerated:  true,
		ConvertedName:  "Type",
