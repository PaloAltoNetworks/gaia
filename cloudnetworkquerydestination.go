...
func (o *CloudNetworkQueryDestination) Validate() error {
	...
	if err := elemental.ValidateStringInList("type", string(o.Type), []string{"Interface", "Instance", "LoadBalancer", "PublicIP", "K8sService"}, true); err != nil {
...
var CloudNetworkQueryDestinationAttributesMap = map[string]elemental.AttributeSpecification{
	...
	"Type": {
		AllowedChoices: []string{"Interface", "Instance", "LoadBalancer", "PublicIP", "K8sService"},
		Autogenerated:  true,
		ConvertedName:  "Type",
