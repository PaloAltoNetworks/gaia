...
const (
	...
	// AWSResourceKindLambdaFunction represents the value LambdaFunction.
	AWSResourceKindLambdaFunction AWSResourceKindValue = "LambdaFunction"
	...
	// AWSResourceKindMachineImage represents the value MachineImage.
	AWSResourceKindMachineImage AWSResourceKindValue = "MachineImage"
	...
	// AWSResourceKindPrefixList represents the value PrefixList.
	AWSResourceKindPrefixList AWSResourceKindValue = "PrefixList"

	// AWSResourceKindRDSDBInstance represents the value RDSDBInstance.
	AWSResourceKindRDSDBInstance AWSResourceKindValue = "RDSDBInstance"

	// AWSResourceKindRedshiftCluster represents the value RedshiftCluster.
	AWSResourceKindRedshiftCluster AWSResourceKindValue = "RedshiftCluster"
	...
	// AWSResourceKindTransitGateway represents the value TransitGateway.
	AWSResourceKindTransitGateway AWSResourceKindValue = "TransitGateway"

	// AWSResourceKindTransitGatewayAttachment represents the value TransitGatewayAttachment.
	AWSResourceKindTransitGatewayAttachment AWSResourceKindValue = "TransitGatewayAttachment"

	// AWSResourceKindTransitGatewayRouteTable represents the value TransitGatewayRouteTable.
	AWSResourceKindTransitGatewayRouteTable AWSResourceKindValue = "TransitGatewayRouteTable"

	// AWSResourceKindVPC represents the value VPC.
	AWSResourceKindVPC AWSResourceKindValue = "VPC"

	// AWSResourceKindVPCPeeringConnection represents the value VPCPeeringConnection.
	AWSResourceKindVPCPeeringConnection AWSResourceKindValue = "VPCPeeringConnection"
)
