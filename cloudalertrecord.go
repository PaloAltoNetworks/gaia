...
func (o *CloudAlertRecord) Validate() error {
	...
	if err := elemental.ValidateStringInList("resourceType", string(o.ResourceType), []string{"Interface", "Instance", "VPC", "Subnet", "K8sService"}, true); err != nil {
		errors = errors.Append(err)
	}
...
raised.`,
	...
	"ResourceType": {
		AllowedChoices: []string{"Interface", "Instance", "VPC", "Subnet", "K8sService"},
		Autogenerated:  true,
