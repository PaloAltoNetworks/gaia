...
const (
	// CloudAlertRecordResourceTypeCosmosDB represents the value CosmosDB.
	CloudAlertRecordResourceTypeCosmosDB CloudAlertRecordResourceTypeValue = "CosmosDB"
	...
	// CloudAlertRecordResourceTypeK8sService represents the value K8sService.
	CloudAlertRecordResourceTypeK8sService CloudAlertRecordResourceTypeValue = "K8sService"

	// CloudAlertRecordResourceTypeLambdaFunction represents the value LambdaFunction.
	CloudAlertRecordResourceTypeLambdaFunction CloudAlertRecordResourceTypeValue = "LambdaFunction"

	// CloudAlertRecordResourceTypeMySQLFlexibleServer represents the value MySQLFlexibleServer.
	CloudAlertRecordResourceTypeMySQLFlexibleServer CloudAlertRecordResourceTypeValue = "MySQLFlexibleServer"

	// CloudAlertRecordResourceTypeMySQLServer represents the value MySQLServer.
	CloudAlertRecordResourceTypeMySQLServer CloudAlertRecordResourceTypeValue = "MySQLServer"

	// CloudAlertRecordResourceTypePostgreSQLFlexibleServer represents the value PostgreSQLFlexibleServer.
	CloudAlertRecordResourceTypePostgreSQLFlexibleServer CloudAlertRecordResourceTypeValue = "PostgreSQLFlexibleServer"

	// CloudAlertRecordResourceTypePostgreSQLServer represents the value PostgreSQLServer.
	CloudAlertRecordResourceTypePostgreSQLServer CloudAlertRecordResourceTypeValue = "PostgreSQLServer"

	// CloudAlertRecordResourceTypeRDSDBInstance represents the value RDSDBInstance.
	CloudAlertRecordResourceTypeRDSDBInstance CloudAlertRecordResourceTypeValue = "RDSDBInstance"

	// CloudAlertRecordResourceTypeRedshiftCluster represents the value RedshiftCluster.
	CloudAlertRecordResourceTypeRedshiftCluster CloudAlertRecordResourceTypeValue = "RedshiftCluster"

	// CloudAlertRecordResourceTypeSQLServer represents the value SQLServer.
	CloudAlertRecordResourceTypeSQLServer CloudAlertRecordResourceTypeValue = "SQLServer"
...
func (o *CloudAlertRecord) Validate() error {
	...
	if err := elemental.ValidateStringInList("resourceType", string(o.ResourceType), []string{"Interface", "Instance", "VPC", "Subnet", "K8sService", "CosmosDB", "SQLServer", "MySQLServer", "MySQLFlexibleServer", "PostgreSQLServer", "PostgreSQLFlexibleServer", "LambdaFunction", "RedshiftCluster", "RDSDBInstance"}, true); err != nil {
		errors = errors.Append(err)
	}
...
raised.`,
	...
	"ResourceType": {
		AllowedChoices: []string{"Interface", "Instance", "VPC", "Subnet", "K8sService", "CosmosDB", "SQLServer", "MySQLServer", "MySQLFlexibleServer", "PostgreSQLServer", "PostgreSQLFlexibleServer", "LambdaFunction", "RedshiftCluster", "RDSDBInstance"},
		Autogenerated:  true,
