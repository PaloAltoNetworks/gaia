...
type AccessReport struct {
	...
	Action AccessReportActionValue `json:"action,omitempty" msgpack:"action,omitempty" bson:"action" mapstructure:"action,omitempty"`

	// Hash of the claims used to communicate.
	ClaimHash string `json:"claimHash,omitempty" msgpack:"claimHash,omitempty" bson:"claimhash" mapstructure:"claimHash,omitempty"`
	...
	Namespace string `json:"-" msgpack:"-" bson:"namespace" mapstructure:"-,omitempty"`
	...
	ProcessingUnitName string `json:"processingUnitName,omitempty" msgpack:"processingUnitName,omitempty" bson:"processingunitname" mapstructure:"processingUnitName,omitempty"`
	...
	// Type of the report.
	Type AccessReportTypeValue `json:"type,omitempty" msgpack:"type,omitempty" bson:"type" mapstructure:"type,omitempty"`
...
type SparseAccessReport struct {
	...
	// The namespace that this access report belongs to. This field is not exposed.
	// Therefore, any value set by the user will be ignored.
	Namespace *string `json:"-" msgpack:"-" bson:"namespace,omitempty" mapstructure:"-,omitempty"`
