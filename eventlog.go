...
type EventLog struct {
	...
	Category string `json:"category,omitempty" msgpack:"category,omitempty" bson:"category" mapstructure:"category,omitempty"`

	// Content of the event log.
	Content string `json:"content,omitempty" msgpack:"content,omitempty" bson:"content" mapstructure:"content,omitempty"`

	// Creation date of the event log.
	Date time.Time `json:"date,omitempty" msgpack:"date,omitempty" bson:"-" mapstructure:"date,omitempty"`

	// Sets the log level.
	Level EventLogLevelValue `json:"level,omitempty" msgpack:"level,omitempty" bson:"level" mapstructure:"level,omitempty"`
	...
	// processing.
	Opaque string `json:"opaque,omitempty" msgpack:"opaque,omitempty" bson:"opaque" mapstructure:"opaque,omitempty"`

	// ID of the object this event log is attached to. The object must be in the same
	// namespace than the event log.
	TargetID string `json:"targetID,omitempty" msgpack:"targetID,omitempty" bson:"targetid" mapstructure:"targetID,omitempty"`

	// Identity of the object this event log is attached to.
	TargetIdentity string `json:"targetIdentity,omitempty" msgpack:"targetIdentity,omitempty" bson:"targetidentity" mapstructure:"targetIdentity,omitempty"`
	...
	Title string `json:"title,omitempty" msgpack:"title,omitempty" bson:"title" mapstructure:"title,omitempty"`
