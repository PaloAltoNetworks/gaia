...
func (o *X509CertificateCheck) GetBSON() (any, error) {
...
func (o *X509CertificateCheck) ValueForAttribute(name string) any {
...
// GetBSON implements the bson marshaling interface.
// This is used to transparently convert ID to MongoDBID as ObectID.
func (o *SparseX509CertificateCheck) GetBSON() (any, error) {
