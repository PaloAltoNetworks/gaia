...
type SuspiciousActivity struct {
	...
	FirstOccurrenceTme time.Time `json:"firstOccurrenceTme" msgpack:"firstOccurrenceTme" bson:"firstoccurrencetme" mapstructure:"firstOccurrenceTme,omitempty"`

	// The timestamp when the suspicious activity last occurred.
	LastOccurrenceTme time.Time `json:"lastOccurrenceTme" msgpack:"lastOccurrenceTme" bson:"lastoccurrencetme" mapstructure:"lastOccurrenceTme,omitempty"`
...
func (o *SuspiciousActivity) GetBSON() (interface{}, error) {
	...
	s.FirstOccurrenceTme = o.FirstOccurrenceTme
	s.LastOccurrenceTme = o.LastOccurrenceTme
...
func (o *SuspiciousActivity) SetBSON(raw bson.Raw) error {
	...
	o.FirstOccurrenceTme = s.FirstOccurrenceTme
	o.LastOccurrenceTme = s.LastOccurrenceTme
...
func (o *SuspiciousActivity) ToSparse(fields ...string) elemental.SparseIdentifiable {
	...
	if len(fields) == 0 {
		...
		return &SparseSuspiciousActivity{
			...
			FirstOccurrenceTme: &o.FirstOccurrenceTme,
			LastOccurrenceTme:  &o.LastOccurrenceTme,
	...
	for _, f := range fields {
		...
		case "firstOccurrenceTme":
			sp.FirstOccurrenceTme = &(o.FirstOccurrenceTme)
		case "lastOccurrenceTme":
			sp.LastOccurrenceTme = &(o.LastOccurrenceTme)
		case "migrationsLog":
...
func (o *SuspiciousActivity) Patch(sparse elemental.SparseIdentifiable) {
	...
	if so.FirstOccurrenceTme != nil {
		o.FirstOccurrenceTme = *so.FirstOccurrenceTme
	}
	if so.LastOccurrenceTme != nil {
		o.LastOccurrenceTme = *so.LastOccurrenceTme
	}
...
func (o *SuspiciousActivity) ValueForAttribute(name string) interface{} {
	...
	case "createTime":
		return o.CreateTime
	case "firstOccurrenceTme":
		return o.FirstOccurrenceTme
	case "lastOccurrenceTme":
		return o.LastOccurrenceTme
	case "migrationsLog":
		return o.MigrationsLog
	case "namespace":
		return o.Namespace
...
var SuspiciousActivityAttributesMap = map[string]elemental.AttributeSpecification{
	...
	"FirstOccurrenceTme": {
		AllowedChoices: []string{},
		BSONFieldName:  "firstoccurrencetme",
		ConvertedName:  "FirstOccurrenceTme",
	...
	"LastOccurrenceTme": {
		AllowedChoices: []string{},
		BSONFieldName:  "lastoccurrencetme",
		ConvertedName:  "LastOccurrenceTme",
...
type SparseSuspiciousActivity struct {
	...
	// The timestamp when the suspicious activity first occurred.
	FirstOccurrenceTme *time.Time `json:"firstOccurrenceTme,omitempty" msgpack:"firstOccurrenceTme,omitempty" bson:"firstoccurrencetme,omitempty" mapstructure:"firstOccurrenceTme,omitempty"`

	// The timestamp when the suspicious activity last occurred.
	LastOccurrenceTme *time.Time `json:"lastOccurrenceTme,omitempty" msgpack:"lastOccurrenceTme,omitempty" bson:"lastoccurrencetme,omitempty" mapstructure:"lastOccurrenceTme,omitempty"`
...
func (o *SparseSuspiciousActivity) GetBSON() (interface{}, error) {
	...
	if o.FirstOccurrenceTme != nil {
		s.FirstOccurrenceTme = o.FirstOccurrenceTme
	}
	if o.LastOccurrenceTme != nil {
		s.LastOccurrenceTme = o.LastOccurrenceTme
	}
...
func (o *SparseSuspiciousActivity) SetBSON(raw bson.Raw) error {
	...
	if s.FirstOccurrenceTme != nil {
		o.FirstOccurrenceTme = s.FirstOccurrenceTme
	}
	if s.LastOccurrenceTme != nil {
		o.LastOccurrenceTme = s.LastOccurrenceTme
	}
...
func (o *SparseSuspiciousActivity) ToPlain() elemental.PlainIdentifiable {
	...
	if o.FirstOccurrenceTme != nil {
		out.FirstOccurrenceTme = *o.FirstOccurrenceTme
	}
	if o.LastOccurrenceTme != nil {
		out.LastOccurrenceTme = *o.LastOccurrenceTme
	}
	if o.MigrationsLog != nil {
...
type mongoAttributesSuspiciousActivity struct {
	...
	FirstOccurrenceTme time.Time                   `bson:"firstoccurrencetme"`
	LastOccurrenceTme  time.Time                   `bson:"lastoccurrencetme"`
...
type mongoAttributesSparseSuspiciousActivity struct {
	...
	FirstOccurrenceTme *time.Time                   `bson:"firstoccurrencetme,omitempty"`
	LastOccurrenceTme  *time.Time                   `bson:"lastoccurrencetme,omitempty"`
	MigrationsLog      *map[string]string           `bson:"migrationslog,omitempty"`
