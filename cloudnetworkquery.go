...
// CloudNetworkQueryAddressMatchCriteriaValue represents the possible values for attribute "addressMatchCriteria".
type CloudNetworkQueryAddressMatchCriteriaValue string
...
type CloudNetworkQuery struct {
	...
	AddressMatchCriteria CloudNetworkQueryAddressMatchCriteriaValue `json:"addressMatchCriteria" msgpack:"addressMatchCriteria" bson:"addressmatchcriteria" mapstructure:"addressMatchCriteria,omitempty"`
...
func (o *CloudNetworkQuery) GetBSON() (interface{}, error) {
	...
	s.AddressMatchCriteria = o.AddressMatchCriteria
	s.AlertOn = o.AlertOn
...
func (o *CloudNetworkQuery) SetBSON(raw bson.Raw) error {
	...
	o.ID = s.ID.Hex()
	o.AddressMatchCriteria = s.AddressMatchCriteria
	o.AlertOn = s.AlertOn
...
func (o *CloudNetworkQuery) ToSparse(fields ...string) elemental.SparseIdentifiable {
	...
	if len(fields) == 0 {
		...
		return &SparseCloudNetworkQuery{
			ID:                   &o.ID,
			AddressMatchCriteria: &o.AddressMatchCriteria,
			AlertOn:              &o.AlertOn,
	...
	for _, f := range fields {
		...
		case "ID":
			sp.ID = &(o.ID)
		case "addressMatchCriteria":
			sp.AddressMatchCriteria = &(o.AddressMatchCriteria)
		case "alertOn":
			sp.AlertOn = &(o.AlertOn)
		case "annotations":
...
func (o *CloudNetworkQuery) Patch(sparse elemental.SparseIdentifiable) {
	...
	if so.AddressMatchCriteria != nil {
		o.AddressMatchCriteria = *so.AddressMatchCriteria
	}
	if so.AlertOn != nil {
		o.AlertOn = *so.AlertOn
	}
...
func (o *CloudNetworkQuery) Validate() error {
	...
	if err := elemental.ValidateStringInList("alertOn", string(o.AlertOn), []string{"SourceVPC", "SourceSubnet", "DestVPC", "DestSubnet", "None"}, false); err != nil {
		errors = errors.Append(err)
	}
...
type SparseCloudNetworkQuery struct {
	...
	// of policy IPs. If set to PartialMatch, a policy match is true if there is an
	// overlap between given IPs and policy IPs.
	AddressMatchCriteria *CloudNetworkQueryAddressMatchCriteriaValue `json:"addressMatchCriteria,omitempty" msgpack:"addressMatchCriteria,omitempty" bson:"addressmatchcriteria,omitempty" mapstructure:"addressMatchCriteria,omitempty"`
...
func (o *SparseCloudNetworkQuery) ToPlain() elemental.PlainIdentifiable {
	...
	if o.AddressMatchCriteria != nil {
		out.AddressMatchCriteria = *o.AddressMatchCriteria
	}
	if o.AlertOn != nil {
		out.AlertOn = *o.AlertOn
	}
	if o.Annotations != nil {
...
type mongoAttributesCloudNetworkQuery struct {
	...
	AddressMatchCriteria CloudNetworkQueryAddressMatchCriteriaValue `bson:"addressmatchcriteria"`
	AlertOn              CloudNetworkQueryAlertOnValue              `bson:"alerton"`
...
type mongoAttributesSparseCloudNetworkQuery struct {
	ID                   bson.ObjectId                               `bson:"_id,omitempty"`
	AddressMatchCriteria *CloudNetworkQueryAddressMatchCriteriaValue `bson:"addressmatchcriteria,omitempty"`
	AlertOn              *CloudNetworkQueryAlertOnValue              `bson:"alerton,omitempty"`
